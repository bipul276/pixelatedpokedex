...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var playPauseImg = document.getElementById('test');

    playPauseImg.addEventListener('click', function() {
       
        if (myMusic.paused) {
            myMusic.play(); 
            playPauseImg.src = 'images/OIP.jpeg'; 
        } else {
            myMusic.pause(); 
            playPauseImg.src = 'images/OIP.jpeg'; 
        }
...
document.addEventListener('DOMContentLoaded', function() {
    var messages = [
        ...
        "Enjoy your stay.",
        "Have a great day!",
        "It's not about being the best right away.",
        "Explore and discover!",
        "Even a Magikarp evolves into a Gyarados.",
